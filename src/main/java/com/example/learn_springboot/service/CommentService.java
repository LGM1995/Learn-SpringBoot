...
import com.example.learn_springboot.entity.Comment;
import com.example.learn_springboot.repository.ArticleRepository;
import com.example.learn_springboot.repository.CommentRepository;
...
public class CommentService {
    ...
    @Transactional // DB와 연관되어 있기 때문에 트랜잭션을 걸어줘야함
